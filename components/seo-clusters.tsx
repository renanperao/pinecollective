                ...
                {cityPages.map((city) => (
                  <li key={city.slug}>
                    <Link
                      ...
                      className="inline-flex items-center rounded-full border border-border/80 bg-secondary/40 px-4 min-h-[40px] text-sm text-foreground/80 transition-all duration-200 hover:border-primary/60 hover:text-primary active:scale-[0.97] transform-gpu"
                    >
                      {city.name}
                    </Link>
                  </li>
